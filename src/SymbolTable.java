...
public class SymbolTable implements Cloneable {
    ...
    public SymbolTable createOuterSymbolTable() {
        ...
        new ClassBuilder(this).addName("Deck").addSuperClass("Location").addField("visible", "int").addMethod("shuffle", "void").addMethod("draw", "void,Location").buildClass(tTable, cTable);
